...
<div class="not-prose float-right mb-5 ml-6 flex w-[180px] flex-col items-center gap-3 rounded-[24px] border border-border bg-light/50 px-4 py-5 text-center md:w-[220px]">
  <img
    src="/images/profile-photo.jfif"
    alt="Steve Tapley"
    class="h-[180px] w-[180px] rounded-full border-2 border-primary/20 object-cover bg-white/70 md:h-[220px] md:w-[220px]"
  />
  <p class="text-sm text-text">Steve Tapley</p>
</div>
